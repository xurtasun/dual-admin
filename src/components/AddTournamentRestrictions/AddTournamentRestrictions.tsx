...
export const AddTournamentRestrictions = ({ restrictions }: Props) => {
  ...
  const setTournamentRestrictions = useAddTournament(state => state.setTournamentRestrictions)
  const newRestriction = useAddTournament(state => state.newRestriction)
  const setNewRestriction = useAddTournament(state => state.setNewRestriction)
  const addNewRestriction = useAddTournament(state => state.addNewRestriction)
  const deleteRestriction = useAddTournament(state => state.deleteRestriction)
